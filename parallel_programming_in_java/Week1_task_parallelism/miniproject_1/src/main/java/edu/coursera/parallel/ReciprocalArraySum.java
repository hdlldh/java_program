...
public final class ReciprocalArraySum {
     ...
     */
    private static int PARALLEL_THRESHOLD = 30000;
    ...
    private static class ReciprocalArraySumTask extends RecursiveAction {
        ...
        protected void compute() {
            // TODO
            if (endIndexExclusive - startIndexInclusive <= PARALLEL_THRESHOLD) {
                double sum = 0;
    ...
    protected static double parManyTaskArraySum(final double[] input,
        ...
        // Compute sum of reciprocals of array elements
        ReciprocalArraySumTask[] taskArr = new ReciprocalArraySumTask[numTasks];
        ...
        for (ReciprocalArraySumTask task: taskArr) {sum += task.getValue();}
